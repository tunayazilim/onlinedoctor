				...
				'<div class="row form-row">' +
					...
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							...
							'<input type="text" name="year_of_completion" value="" class="form-control">' +
						'</div>' +
					'</div>' +
				'</div>' +
			'</div>' +
    ...
    $(".add-experience").on('click', function () {
		...
		'<div class="col-12 col-md-5">' +
			'<div class="form-group">' +
				...
				'<input type="text" name="hospital_name" value="" class="form-control">' +
			'</div>' +
		'</div>' +
		'<div class="col-12 col-md-5">' +
			'<div class="form-group">' +
				'<label>Çalışma Yılları</label>' +
    ...
    $(".add-award").on('click', function () {
        ...
        var regcontent = '<div class="row form-row awards-cont">' +
			'<div class="col-12 col-md-5">' +
				'<div class="form-group">' +
					'<label>Ödüller</label>' +
					'<input type="text" name="award_name" value="" class="form-control">' +
				'</div>' +
			'</div>' +
			'<div class="col-12 col-md-5">' +
				'<div class="form-group">' +
